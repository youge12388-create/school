...
export const schools = sqliteTable(
  "schools",
  {
    ...
    cooperationDeadlineText: text("cooperation_deadline_text"),
    companyRecruitmentQuotaText: text("company_recruitment_quota_text"),
    schoolRecruitmentPlanText: text("school_recruitment_plan_text"),
    recruitmentPreferenceText: text("recruitment_preference_text"),
    languageStudentAssessmentText: text("language_student_assessment_text"),
    degreeStudentAssessmentText: text("degree_student_assessment_text"),
